    ...
    <div className="min-h-screen bg-background bg-grain">
      ...
      <section className="relative pt-16 min-h-[100svh] flex items-center overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-10 py-24 w-full">
          <div className="max-w-2xl">
            ...
            <h1 className="mt-6 font-display uppercase text-5xl sm:text-6xl lg:text-8xl leading-[0.95] text-balance">
              Built Right.
              <br />
            ...
            <div className="mt-10 flex flex-wrap items-center gap-4">
              <Link
                to="/contact"
                className="group inline-flex items-center gap-2 rounded-md bg-primary px-7 py-3.5 text-sm font-semibold uppercase tracking-wider text-primary-foreground hover:opacity-90 transition shadow-elegant"
              >
                Get a Free Quote
              ...
              <Link
                to="/services"
                className="inline-flex items-center gap-2 rounded-md border border-border px-7 py-3.5 text-sm font-semibold uppercase tracking-wider text-foreground hover:border-primary hover:text-primary transition"
              >
                Our Services
              </Link>
            </div>
        ...
        {/* Trust bar */}
        <div className="absolute bottom-0 inset-x-0 border-t border-border/60 bg-card/60 backdrop-blur">
          <div className="max-w-7xl mx-auto px-6 lg:px-10 py-6 grid grid-cols-1 sm:grid-cols-3 gap-6">
            {[
              ...
              <div key={item.label} className="flex items-center gap-3 justify-center sm:justify-start">
                <span className="h-10 w-10 rounded-md border border-primary/30 bg-primary/5 flex items-center justify-center">
                  <item.icon className="h-5 w-5 text-primary" />
                </span>
                <span className="text-sm uppercase tracking-widest text-foreground">{item.label}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-28">
        <div className="max-w-5xl mx-auto px-6 lg:px-10 text-center">
          <p className="text-xs uppercase tracking-[0.3em] text-primary">Craftsmanship You Can Stand On</p>
          <h2 className="mt-4 font-display uppercase text-4xl sm:text-5xl text-balance">
          ...
          <div className="mt-10">
            <Link
              to="/about"
              className="inline-flex items-center gap-2 text-primary text-sm uppercase tracking-widest hover:gap-3 transition-all"
            >
