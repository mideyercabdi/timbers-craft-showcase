      ...
      <section className="pb-20">
        <div className="max-w-7xl mx-auto px-6 lg:px-10 grid lg:grid-cols-5 gap-10">
          <form
            ...
            className="lg:col-span-3 rounded-lg border border-border bg-card/60 p-8 space-y-5"
          >
            ...
            <div>
              ...
              <textarea
                ...
                className="mt-2 w-full rounded-md bg-input/50 border border-border px-4 py-3 text-foreground placeholder:text-muted-foreground/60 focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary transition"
              />
            </div>
            <button
              type="submit"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-md bg-primary px-8 py-3.5 text-sm font-semibold uppercase tracking-wider text-primary-foreground hover:opacity-90 transition"
            >
              {sent ? (
                <>
          ...
          <aside className="lg:col-span-2 space-y-4">
            ...
            <div className="rounded-lg overflow-hidden border border-border bg-card/60 aspect-square">
              <iframe
                title="Map"
...
function InfoCard({
  ...
  return (
    <div className="rounded-lg border border-border bg-card/60 p-5 flex items-start gap-4">
      ...
      <div>
        ...
        <p className="mt-1 text-foreground font-medium">{value}</p>
      </div>
    </div>
  );
}
