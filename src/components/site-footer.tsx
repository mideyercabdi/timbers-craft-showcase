  ...
  return (
    <footer className="border-t border-border/60 bg-card/40 mt-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-10 py-14 grid gap-10 md:grid-cols-3">
        ...
        <div>
          <h4 className="text-xs uppercase tracking-[0.2em] text-primary mb-4">Quick Links</h4>
        ...
        <div>
          <h4 className="text-xs uppercase tracking-[0.2em] text-primary mb-4">Get In Touch</h4>
